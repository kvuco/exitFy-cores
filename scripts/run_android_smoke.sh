...
case "$(basename "$core")" in
  libxray-arm64-v8a.so) abi="arm64-v8a"; compiler="aarch64-linux-android26-clang" ;;
  libxray-armeabi-v7a.so) abi="armeabi-v7a"; compiler="armv7a-linux-androideabi26-clang" ;;
  libxray-x86.so) abi="x86"; compiler="i686-linux-android26-clang" ;;
  libxray-x86_64.so) abi="x86_64"; compiler="x86_64-linux-android26-clang" ;;
  *) echo "unsupported core artifact name: $core" >&2; exit 2 ;;
esac
